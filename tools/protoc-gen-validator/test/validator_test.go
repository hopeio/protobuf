...
func buildProto3(someString string, someInt uint32, identifier string, someValue int64, someDoubleStrict float64,
	...
	goodProto3 := &ValidatorMessage3{
		...
		SomeStringResp:      []string{someString, "xyz34"},
		SomeStringNoQuotes:  someString,
		SomeStringUnescaped: someString,

		SomeInt:            someInt,
		SomeIntResp:        []uint32{someInt, 12, 13, 14, 15, 16},
		SomeIntRespNonNull: []uint32{someInt, 102},

		SomeEmbedded:                nil,
		SomeEmbeddedNonNullable:     goodEmbeddedProto3,
		SomeEmbeddedExists:          goodEmbeddedProto3,
		SomeEmbeddedResp:            []*ValidatorMessage3_EmbeddedMessage{goodEmbeddedProto3},
		SomeEmbeddedRespNonNullable: []*ValidatorMessage3_EmbeddedMessage{goodEmbeddedProto3},

		StrictSomeDouble:            someDoubleStrict,
		StrictSomeDoubleResp:        []float64{someDoubleStrict, 0.5, 0.55, 0.6},
		StrictSomeDoubleRespNonNull: []float64{someDoubleStrict, 0.5, 0.55, 0.6},
		StrictSomeFloat:             someFloatStrict,
		StrictSomeFloatResp:         []float32{someFloatStrict, 0.5, 0.55, 0.6},
		StrictSomeFloatRespNonNull:  []float32{someFloatStrict, 0.5, 0.55, 0.6},

		SomeDouble:            someDouble,
		SomeDoubleResp:        []float64{someDouble, 0.5, 0.55, 0.6},
		SomeDoubleRespNonNull: []float64{someDouble, 0.5, 0.55, 0.6},
		SomeFloat:             someFloat,
		SomeFloatResp:         []float32{someFloat, 0.5, 0.55, 0.6},
		SomeFloatRespNonNull:  []float32{someFloat, 0.5, 0.55, 0.6},
...
func buildProto2(someString string, someInt uint32, identifier string,
	...
	goodProto2 := &ValidatorMessage{
		...
		IntResp:        []uint32{someInt, 12, 13, 14, 15, 16},
		IntRespNonNull: []uint32{someInt, 12, 13, 14, 15, 16},

		EmbeddedReq:             goodEmbeddedProto2,
		EmbeddedNonNull:         goodEmbeddedProto2,
		EmbeddedResp:            []*ValidatorMessage_EmbeddedMessage{goodEmbeddedProto2},
		EmbeddedRespNonNullable: []*ValidatorMessage_EmbeddedMessage{goodEmbeddedProto2},
