...
var (
	proto3ConvertFuncs = map[descriptorpb.FieldDescriptorProto_Type]string{
		descriptorpb.FieldDescriptorProto_TYPE_DOUBLE:  "text.Float64",
		descriptorpb.FieldDescriptorProto_TYPE_FLOAT:   "text.Float32",
		descriptorpb.FieldDescriptorProto_TYPE_INT64:   "text.Int64",
		descriptorpb.FieldDescriptorProto_TYPE_UINT64:  "text.Uint64",
		descriptorpb.FieldDescriptorProto_TYPE_INT32:   "text.Int32",
		descriptorpb.FieldDescriptorProto_TYPE_FIXED64: "text.Uint64",
		descriptorpb.FieldDescriptorProto_TYPE_FIXED32: "text.Uint32",
		descriptorpb.FieldDescriptorProto_TYPE_BOOL:    "text.Bool",
		descriptorpb.FieldDescriptorProto_TYPE_STRING:  "text.String",
		...
		descriptorpb.FieldDescriptorProto_TYPE_SINT64:   "text.Int64",
	}

	proto3RepeatedConvertFuncs = map[descriptorpb.FieldDescriptorProto_Type]string{
		descriptorpb.FieldDescriptorProto_TYPE_DOUBLE:  "text.Float64Slice",
		descriptorpb.FieldDescriptorProto_TYPE_FLOAT:   "text.Float32Slice",
		descriptorpb.FieldDescriptorProto_TYPE_INT64:   "text.Int64Slice",
		descriptorpb.FieldDescriptorProto_TYPE_UINT64:  "text.Uint64Slice",
		descriptorpb.FieldDescriptorProto_TYPE_INT32:   "text.Int32Slice",
		descriptorpb.FieldDescriptorProto_TYPE_FIXED64: "text.Uint64Slice",
		descriptorpb.FieldDescriptorProto_TYPE_FIXED32: "text.Uint32Slice",
		descriptorpb.FieldDescriptorProto_TYPE_BOOL:    "text.BoolSlice",
		descriptorpb.FieldDescriptorProto_TYPE_STRING:  "text.StringSlice",
		// FieldDescriptorProto_TYPE_GROUP
		// FieldDescriptorProto_TYPE_MESSAGE
		...
		descriptorpb.FieldDescriptorProto_TYPE_SINT64:   "text.Int64Slice",
	}

	proto2ConvertFuncs = map[descriptorpb.FieldDescriptorProto_Type]string{
		descriptorpb.FieldDescriptorProto_TYPE_DOUBLE:  "text.Float64P",
		descriptorpb.FieldDescriptorProto_TYPE_FLOAT:   "text.Float32P",
		descriptorpb.FieldDescriptorProto_TYPE_INT64:   "text.Int64P",
		descriptorpb.FieldDescriptorProto_TYPE_UINT64:  "text.Uint64P",
		descriptorpb.FieldDescriptorProto_TYPE_INT32:   "text.Int32P",
		descriptorpb.FieldDescriptorProto_TYPE_FIXED64: "text.Uint64P",
		descriptorpb.FieldDescriptorProto_TYPE_FIXED32: "text.Uint32P",
		descriptorpb.FieldDescriptorProto_TYPE_BOOL:    "text.BoolP",
		...
		descriptorpb.FieldDescriptorProto_TYPE_SINT64:   "text.Int64P",
	}
