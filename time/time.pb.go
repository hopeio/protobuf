...
const file_hopeio_time_time_proto_rawDesc = "" +
	"\n" +
	"\x16hopeio/time/time.proto\x12\x04time\" \n" +
	"\bNanoTime\x12\x14\n" +
	"\x05nanos\x18\x01 \x01(\x03R\x05nanos\"#\n" +
	"\tMacroTime\x12\x16\n" +
	"\x06macros\x18\x01 \x01(\x03R\x06macros\"#\n" +
	"\tMilliTime\x12\x16\n" +
	"\x06millis\x18\x01 \x01(\x03R\x06millis\"&\n" +
	"\n" +
	"SecondTime\x12\x18\n" +
	"\aseconds\x18\x01 \x01(\x03R\aseconds\"\x1a\n" +
	"\x04Date\x12\x12\n" +
	"\x04days\x18\x01 \x01(\x05R\x04days\"&\n" +
	"\bDuration\x12\x1a\n" +
	"\bduration\x18\x01 \x01(\x03R\bduration\"#\n" +
	"\tTimestamp\x12\x16\n" +
	"\x06millis\x18\x01 \x01(\x03R\x06millis\"6\n" +
	"\x04Time\x12\x18\n" +
