...
const file_hopeio_response_response_proto_rawDesc = "" +
	"\n" +
	"\x1ehopeio/response/response.proto\x12\bresponse\x1a\x19google/protobuf/any.proto\x1a\x0epatch/go.proto\"p\n" +
	"\n" +
	"CommonResp\x12&\n" +
	"\x04code\x18\x01 \x01(\x05B\x12ʵ\x03\x0e\xa2\x01\vjson:\"code\"R\x04code\x12\x10\n" +
