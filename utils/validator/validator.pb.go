...
const file_hopeio_utils_validator_validator_proto_rawDesc = "" +
	"\n" +
	"&hopeio/utils/validator/validator.proto\x12\tvalidator\x1a google/protobuf/descriptor.proto\"\xc1\x04\n" +
	"\x0eFieldValidator\x12\x14\n" +
	...
	"\n" +
	"msg_exists\x18\x04 \x01(\bR\tmsgExists\x12!\n" +
	"\fcustom_error\x18\x05 \x01(\tR\vcustomError\x12\x19\n" +
	"\bfloat_gt\x18\x06 \x01(\x01R\afloatGt\x12\x19\n" +
	"\bfloat_lt\x18\a \x01(\x01R\afloatLt\x12#\n" +
	"\rfloat_epsilon\x18\b \x01(\x01R\ffloatEpsilon\x12\x1b\n" +
	"\tfloat_gte\x18\t \x01(\x01R\bfloatGte\x12\x1b\n" +
	"\tfloat_lte\x18\n" +
	" \x01(\x01R\bfloatLte\x12(\n" +
	"\x10string_not_empty\x18\v \x01(\bR\x0estringNotEmpty\x12,\n" +
	"\x12repeated_count_min\x18\f \x01(\x03R\x10repeatedCountMin\x12,\n" +
	"\x12repeated_count_max\x18\r \x01(\x03R\x10repeatedCountMax\x12\x1b\n" +
	"\tlength_gt\x18\x0e \x01(\x03R\blengthGt\x12\x1b\n" +
	"\tlength_lt\x18\x0f \x01(\x03R\blengthLt\x12\x1b\n" +
	"\tlength_eq\x18\x10 \x01(\x03R\blengthEq\x12\x1c\n" +
	"\n" +
	"is_in_enum\x18\x11 \x01(\bR\bisInEnum\x12\x19\n" +
	"\buuid_ver\x18\x12 \x01(\x05R\auuidVer\",\n" +
	"\x0eOneofValidator\x12\x1a\n" +
	"\brequired\x18\x01 \x01(\bR\brequired:P\n" +
	"\x05field\x12\x1d.google.protobuf.FieldOptions\x18\xfc\xfb\x03 \x01(\v2\x19.validator.FieldValidatorR\x05field:P\n" +
	"\x05oneof\x12\x1d.google.protobuf.OneofOptions\x18\xfd\xfb\x03 \x01(\v2\x19.validator.OneofValidatorR\x05oneofBP\n" +
	"\"xyz.hoper.protobuf.utils.validatorZ*github.com/hopeio/protobuf/utils/validator"

var (
	file_hopeio_utils_validator_validator_proto_rawDescOnce sync.Once
	file_hopeio_utils_validator_validator_proto_rawDescData []byte
)
...
func file_hopeio_utils_validator_validator_proto_rawDescGZIP() []byte {
	file_hopeio_utils_validator_validator_proto_rawDescOnce.Do(func() {
		file_hopeio_utils_validator_validator_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_hopeio_utils_validator_validator_proto_rawDesc), len(file_hopeio_utils_validator_validator_proto_rawDesc)))
	})
...
func file_hopeio_utils_validator_validator_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_hopeio_utils_validator_validator_proto_rawDesc), len(file_hopeio_utils_validator_validator_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 2,
			NumServices:   0,
