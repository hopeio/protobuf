...
var file_hopeio_utils_validator_validator_proto_goTypes = []interface{}{
...
func file_hopeio_utils_validator_validator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_hopeio_utils_validator_validator_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_hopeio_utils_validator_validator_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
