...
func file_hopeio_request_param_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_hopeio_request_param_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Page); i {
			case 0:
				return &v.state
			case 1:
		...
		file_hopeio_request_param_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Id); i {
			case 0:
				return &v.state
			case 1:
		...
		file_hopeio_request_param_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*IdStr); i {
			case 0:
				return &v.state
			case 1:
		...
		file_hopeio_request_param_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Cursor); i {
			case 0:
				return &v.state
			case 1:
		...
		file_hopeio_request_param_proto_msgTypes[4].Exporter = func(v any, i int) any {
